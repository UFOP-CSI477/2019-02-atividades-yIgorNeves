@extends('layouts.app', ['page' => __('Seu Perfil'), 'pageSlug' => 'profile'])

@section('pageTitle', 'Seu Perfil')
                ...
                <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>{{ __('Confirme sua nova senha') }}</label>
                            <input type="password" name="password_confirmation" class="form-control" placeholder="{{ __('Confirme sua nova senha') }}" value="" required>
                        </div>
                    </div>
                    <div class="card-footer">
